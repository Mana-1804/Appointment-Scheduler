...
const appointments = [];
        ...
        document.getElementById('appointmentForm').addEventListener('submit', function(e) {
            ...
            if (isTimeClash(time)) {
                alert("There's already an appointment scheduled for this time. Please choose another time.");
                return;
            }
        ...
        function isTimeClash(newTime) {
            return appointments.some(appointment => appointment.time === newTime);
        }
        ...
        function displayAppointments() {
            ...
            appointments.forEach(appointment => {
                ...
                p.textContent = `${appointment.name} - ${appointment.time}`;
